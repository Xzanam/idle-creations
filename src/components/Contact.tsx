...
import { Mail, Camera, Mic2, Send, Check } from 'lucide-react'
...
const CONTACT_POINTS = [
  {
    ...
    hint: 'hello@idlecreations.com.au',
  },
  {
    icon: Mic2,
    title: 'Artist / Talent',
    hint: 'talent@idlecreations.com.au',
  },
  {
    icon: Camera,
    title: 'Production',
    hint: 'productions@idlecreations.com.au',
  },
]
      ...
      {sent ? (
        ...
        <form onSubmit={handleSubmit} className="grid gap-9 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            <button
              type="submit"
              className="group inline-flex items-center gap-2 bg-brand-orange px-8 py-4 font-display text-sm font-semibold uppercase tracking-[0.12em] text-white transition-colors hover:bg-brand-charcoal"
            >
              Send Enquiry
                ...
                <Reveal key={point.title} delay={i * 0.08}>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <point.icon className="h-5 w-5 text-brand-orange" aria-hidden="true" />
                      <div>
